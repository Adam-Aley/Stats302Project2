...
#' \describe{
#'   \item{species}{a factor denoting penguin species (Adélie, Chinstrap and
#'   Gentoo)}
...
#'  Structural size measurements and isotopic signatures of foraging among adult
#'   male and female Adélie penguins (Pygoscelis adeliae) nesting along the
#'   Palmer Archipelago near Palmer Station, 2007-2009 ver 5. Environmental Data
#'    Initiative} \url{https://doi.org/10.6073/pasta/98b16d7d563f265cb52372c8ca99e60f}
#' @source {Gentoo penguins: Palmer Station Antarctica LTER and K. Gorman. 2020.
#'  Structural size measurements and isotopic signatures of foraging among adult
#'   male and female Gentoo penguin (Pygoscelis papua) nesting along the Palmer
#'   Archipelago near Palmer Station, 2007-2009 ver 5. Environmental Data
#'   Initiative} \url{https://doi.org/10.6073/pasta/7fca67fb28d56ee2ffa3d9370ebda689}
#' @source {Chinstrap penguins: Palmer Station Antarctica LTER and K. Gorman.
#' 2020. Structural size measurements and isotopic signatures of foraging among
...
#'   Environmental Data Initiative} \url{https://doi.org/10.6073/pasta/c14dfcfada8ea13a17536e73eb6fbe9e}
...
#'  of Antarctic Penguins (Genus Pygoscelis). PLoS ONE 9(3): e90081. doi:10.1371/journal.pone.0090081}
"my_penguins"
